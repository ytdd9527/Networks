...
public class ItemsModel {
    ...
    public static final ChaingPusher NE_MODEL_CHAING_PUSHER_PLUS;
    ...
    static {
        ...
        NE_MODEL_CHAING_PUSHER = new ChaingPusher(NetworksItemGroups.DISABLED_ITEMS, ItemStacksModel.NE_MODEL_CHAING_PUSHER, RecipeType.NULL,null,"NE_MODEL_CHAING_PUSHER");
        NE_MODEL_CHAING_PUSHER_PLUS = new ChaingPusher(NetworksItemGroups.DISABLED_ITEMS, ItemStacksModel.NE_MODEL_CHAING_PUSHER_PLUS,RecipeType.NULL,null,"NE_MODEL_CHAING_PUSHER_PLUS");

...
public class ChaingPusherPlus extends NetworkDirectional implements RecipeDisplayItem {
    ...
    public ChaingPusherPlus(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {

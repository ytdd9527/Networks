...
public class NetworkMorePusher extends NetworkDirectional {
    ...
    private static final int[] BACKGROUND_SLOTS = new int[]{
            0, 1, 2, 3, 4, 5, 6, 8, 9, 10, 12, 13, 18, 20, 22, 23, 27, 28, 30, 31, 36, 37, 38, 39, 40, 41, 42, 43, 44
    };
    private static final int[] TEMPLATE_BACKGROUND = new int[]{7};
    private static final int[] TEMPLATE_SLOTS = new int[]{15, 16, 17, 24, 25, 26, 33, 34, 35};
